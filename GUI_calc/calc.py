...
btn_mlt = tk.Button(root, text="*", command=lambda: add_to_calc("*"), width=5, font=("Arial", 14))
btn_mlt.grid(row=4, column=4)
...
btn_eq = tk.Button(root, text="=", command=evaluate_calc, width=11, font=("Arial", 14))
